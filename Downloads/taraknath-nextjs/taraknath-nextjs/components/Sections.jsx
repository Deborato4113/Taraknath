...
export function CustomersSection() {
  ...
  return (
    <section className="bg-gray-950 py-20 sm:py-24 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        <Reveal className="text-center mb-16">
          <Eyebrow className="flex justify-center text-red-500">Trusted By</Eyebrow>
          <h2 className="text-2xl sm:text-3xl font-bold text-white heading-font uppercase">
            Our Customers
          </h2>
      ...
      >
        ...
        {paused && (
          <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none">
            <span className="mono text-[11px] text-gray-500 tracking-widest uppercase bg-gray-950/80 px-4 py-2 border border-gray-800">
  ...
  >
    <CardWrapper>
      <>
        <div
          className="flex flex-col items-center justify-center border transition-all duration-300"
          style={{
            width: "220px",
            height: "120px",
            borderColor: hoveredIdx === i ? "#dc2626" : "#1f2937",
            backgroundColor: hoveredIdx === i ? "#111827" : "#0f172a",
            transform:
              hoveredIdx === i
            ...
            boxShadow:
              hoveredIdx === i
                ? "0 10px 32px rgba(220,38,38,0.25)"
                : "none",
            padding: "14px 18px",
          }}
        >
          {customer.logo ? (
            ...
            <p
              className="font-bold text-center leading-snug transition-all duration-300 heading-font uppercase text-sm"
              style={{
                color: hoveredIdx === i ? "#ffffff" : "#4b5563",
              }}
            >
              {customer.short}
            </p>
        ...
        <div
          className="absolute -bottom-10 left-1/2 -translate-x-1/2 whitespace-nowrap mono text-[10px] text-gray-400 tracking-wide text-center transition-all duration-200 pointer-events-none"
          style={{
