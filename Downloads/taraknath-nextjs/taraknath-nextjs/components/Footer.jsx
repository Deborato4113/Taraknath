...
const SERVICE_LINKS = [
  ...
  { label: "White Metal Lining Bearings", href: "/products/bearing" },
];
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-16 grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="lg:col-span-1">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 bg-red-600 flex items-center justify-center text-white font-bold text-sm heading-font flex-shrink-0">
              TE
            </div>
