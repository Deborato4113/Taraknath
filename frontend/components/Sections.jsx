...
import { Play, MapPin, Phone, Mail, Send, X } from "lucide-react";
    ...
    <div className="relative bg-gray-900 text-white overflow-hidden">
      ...
      {videoOpen && (
        ...
        >
          ...
          <video
            src="/videos/watch-our-work.mp4"
            controls
            autoPlay
            playsInline
            className="w-full max-w-4xl max-h-[85vh] bg-black"
          ...
          <Reveal>
            ...
            <div className="space-y-5">
              {[
                ...
                { Icon: Mail, text: "deboratochaudhury2023@gmail.com" },
              ].map(({ Icon, text }, i) => (
