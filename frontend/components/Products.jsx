...
import { Anchor, Cog, CircleGauge, ShieldCheck, Layers, Wrench, ArrowUpRight } from "lucide-react";
...
const CATEGORY_META = [
  ...
  },
  {
    ...
    blurb: "Tilting thrust pads, babbit and journal bearings, labyrinth seals and bearing housings lined and machined in-house.",
  ...
  },
  {
    ...
    blurb: "Pinions & gears, gear box assemblies, and aluminium/steel gratings fabricated and machined to specification.",
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-14">
          ...
          <Reveal delay={100}>
            <p className="text-gray-500 text-sm max-w-sm mb-3">
              Six core lines of manufacture, each built to project-grade specification.
              Click a category to explore all items.
            </p>
            <Link
              href="/products"
              className="inline-flex items-center gap-1.5 text-xs font-semibold tracking-widest uppercase text-blue-800 hover:text-red-600 transition-colors"
            >
              Search All Products <ArrowUpRight size={12} />
            </Link>
          </Reveal>
        </div>
